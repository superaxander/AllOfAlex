...
import static alexanders.mods.aoa.init.Resources.resourceAssimilatedTile;
...
public class AssimilatorContainer extends ItemContainer {
    public AssimilatorContainer(AbstractEntityPlayer player, IInventory containedInventory) {
        ...
        this.addSlot(new RestrictedSlot(containedInventory, 0, 40, 0, (slot, item) -> slot.inventory.get(slot.slot) == null && item.getItem() instanceof ItemTile));
        this.addSlot(new RestrictedSlot(containedInventory, 1, 140, 0, (slot, item) -> slot.inventory.get(slot.slot) == null && item.getItem() instanceof ItemTile));
