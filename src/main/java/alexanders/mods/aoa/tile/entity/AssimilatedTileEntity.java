...
public class AssimilatedTileEntity extends TileEntity {
    ...
    public void save(DataSet set, boolean forSync) {
        ...
        if (tileName != null) set.addString("tileName", tileName.toString());
    ...
    public void load(DataSet set, boolean forSync) {
        ...
        if (set.hasKey("tileName")) tileName = new ResourceName(set.getString("tileName"));
        if (set.hasKey("override")) {
            override = set.getBoolean("override");
            if (override && set.hasKey("minX")) bb = new BoundBox(set.getDouble("minX"), set.getDouble("minY"), set.getDouble("maxX"), set.getDouble("maxY"));
        }
    }
