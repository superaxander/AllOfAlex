...
public class DrillContainer extends ItemContainer {
    public DrillContainer(AbstractEntityPlayer player, TileEntityDrill tile, IInventory... containedInventories) {
        super(player);
        this.addSlot(new RestrictedSlot(tile.fuelInventory, 0, 90, 0,
                                        (slot, instance) -> instance.getItem() == GameContent.TILE_LOG.getItem() || instance.getItem() == GameContent.TILE_COAL
                                                .getItem())); //TODO: Change this once fuel is reimplemented
