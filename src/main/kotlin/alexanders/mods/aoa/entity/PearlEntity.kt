...
class PearlEntity(world: IWorld, player: UUID? = null, mouseDirection: FloatArray = floatArrayOf(0f, 0f)) : Entity(world) {
    val renderer = PearlRenderer<BouncyPearlEntity>(Resources.pearlResource)
