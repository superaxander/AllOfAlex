...
import alexanders.mods.aoa.init.Resources.TELEPORTATION_PARTICLE_RESOURCE
...
class TeleportationParticle(world: IWorld, x: Double, y: Double, motionX: Double = randomSignedDouble() * .3, motionY: Double = (Util.RANDOM.nextDouble()) * .3,
                            maxLife: Int = 60) : PearlParticle(TELEPORTATION_PARTICLE_RESOURCE, world, x, y, motionX, motionY, maxLife) {
